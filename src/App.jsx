      ...
      <div>
        ...
        {/* PAYPAL BUTTON */}
            ...
            <div className="pt-3 mt-2">
              {clubA2?.is_payable ? (
                <div className="relative" id="paypal-shell-a2">
                  {theme === "dark" && (
                    <div className="absolute left-[6px] right-[6px] top-[-2px] bottom-[6px] bg-white rounded-xl" />
                  )}
                ...
                <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/60 px-4 py-4 text-center text-sm sm:text-base text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 rounded-2xl">
          <div className="p-4 flex flex-col divide-y divide-slate-200 dark:divide-slate-800">
            ...
            <ul className="pt-2 list-disc pl-5 text-base leading-snug text-slate-700 dark:text-slate-300 space-y-0">
             ...
             <div className="pt-3 mt-2">
              {clubB1B2?.is_payable ? (
                <div className="relative" id="paypal-shell-b1b2">
                  {theme === "dark" && (
                    <div className="absolute left-[6px] right-[6px] top-[-2px] bottom-[6px] bg-white rounded-xl" />
                  )}
