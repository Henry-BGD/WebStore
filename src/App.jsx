...
const I18N = {
  ...
  ru: {
    ...
    about_p1:
      "Я помогаю англоговорящим быстрее и увереннее читать по-русски: делаю билингвальные книги с аудио, объясняю грамматику простым языком и создаю практические задания.",
    ...
    audio_choose: "Выберите книгу — откроется список глав с прослушиванием и скачиванием.",
    back: "Назад",
